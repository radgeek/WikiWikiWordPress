<?php
/*
Plugin Name: WikiWikiWordPress
Plugin URI: http://wikiwikiwordpress.radgeek.com/
Description: Add Wiki functionality to your wordpress site.
Version: 2011.1029
Author: Charles Johnson, Dan Milward, Matthew Gerring
...
class WP_Wiki {
	...
	function WP_Wiki() {
		...
		*/
		...
		add_action('template_redirect', array($WikiPageController, 'check_for_redirect'), -1000);
